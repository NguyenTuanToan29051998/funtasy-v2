...
export const Button: React.FC<Props> = (props) => {
	...
	return (
		<button className="relative font-ppNeueMontrealMedium bg-black text-black hover:text-white text-sm lg:text-base px-3 py-[10px] lg:px-4 lg:py-2 rounded-full overflow-hidden group">
